...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm p-4">
        <form action="{{ route('artist.transactions') }}" method="GET" class="flex gap-4">
            ...
            @if(request('status'))
                <a href="{{ route('artist.transactions') }}" class="px-4 py-2 border border-gray-200 rounded-lg hover:bg-gray-50">Clear</a>
            @endif
        </form>
    </div>
